...
class SellerAPI:
    ...
    def login(self, seller_id: int, password: str) -> Tuple[bool, int]:
    ...
    def register(self, seller_data: dict) -> Tuple[bool, int]:
        seller = Seller([seller_data['nome_usuario'], seller_data['senha']])
        seller_id = self.sgbd.insert("vendedor", seller.columns, seller.values, ("vendedor_id",))[0]
